    ...
    <div className="flex-1 flex items-center justify-center py-12 px-4 bg-gray-50 dark:bg-slate-900 transition-colors">
      <div className="w-full max-w-md bg-white dark:bg-slate-800 p-8 rounded-2xl border border-gray-150 dark:border-slate-750 premium-shadow space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-lg font-bold text-gray-800 dark:text-white">Create a New Account</h2>
          <p className="text-xs text-gray-500 dark:text-gray-400">Join ShopSphere today for premium deals and checkout.</p>
        </div>
        ...
        >
          <Chrome size={16} className="text-red-500" /> Sign Up with Google
        </button>

        {/* Sign in switch */}
        <p className="text-xs text-center text-gray-500 dark:text-gray-400">
          Already have an account?{' '}
          <Link to="/login" className="text-amazon-gold font-bold hover:underline">
            Sign In
          </Link>
        </p>
